...
{
    /// <summary>
    /// IComparer implementation used to order help keys.
    /// </summary>
    public class HelpKeyComparer : IComparer<string>
    {
        ...
        /// </summary>
        public static HelpKeyComparer Instance { get; } = new HelpKeyComparer();
